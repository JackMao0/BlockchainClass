...
var rpc_str = "https://rpcapi.fantom.network";
...
function swapEthToTokens() {
    ...
    var input_type = abiTool.getAbiByJsNameAndFunctionName("spookySwapAbi","swapETHForExactTokens")
...
function swapTokensToEth() {
    ...
    var input_type = abiTool.getAbiByJsNameAndFunctionName("spookySwapAbi","swapExactTokensForETH")
...
async function tokenToToken() {
    ...
    var input_type = abiTool.getAbiByJsNameAndFunctionName("spookySwapAbi","swapExactTokensForTokens")
    var path = [parameter_map['paytokenaddress'],parameter_map['wAddress'],parameter_map['gettokenaddress']]
