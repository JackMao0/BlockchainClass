...
function swapEthToTokens() {
    ...
    var input_type = abiTool.getAbiByJsNameAndFunctionName("pancakeAbi","swapETHForExactTokens")
...
function swapTokensToEth() {
    ...
    var input_type = abiTool.getAbiByJsNameAndFunctionName("pancakeAbi","swapExactTokensForETH")
...
async function tokenToToken() {
    ...
    var input_type = abiTool.getAbiByJsNameAndFunctionName("pancakeAbi","swapExactTokensForTokens")
